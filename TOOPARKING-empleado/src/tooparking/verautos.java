    ...
    public verautos() {
        initComponents();
         ...
         if(b_placa.getText().length()==0){
             consulta= "SELECT vehre_placa, vehre_descrip, Fecha_registro, vehre_foto FROM vehiculos_registrados WHERE tipveh_cod='1'";
             ver_veh();
         }
        ...
        b_placa.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent de) {
                ...
                if(b_placa.getText().length()>0){
                    ...
                    consulta="SELECT vehre_placa, vehre_descrip, Fecha_registro, vehre_foto FROM vehiculos_registrados WHERE tipveh_cod='1' and vehre_placa LIKE '"+b_placa.getText()+'%'+"'";
                    ver_veh();
...
public int actualizar=0;    
  ...
  try {
   ...
   Phrase fechaa=new Phrase(dia+"-"+mess+"-"+año,FontFactory.getFont(FontFactory.HELVETICA,13, com.itextpdf.text.Font.NORMAL, BaseColor.BLACK));
  ...
  documento.add(dd);
   ...
   // Atrapamos excepciones concernientes al I/O.
    ...
    JOptionPane.showMessageDialog(null, "Tiquete generado!.");
        ...
        resultados.setText("Resultados: "+re);
    }catch(Exception e){
    ...
    private void initComponents() {
        ...
        b_placa.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        ...
        resultados1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel3.add(resultados1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, -1, -1));

        resultados.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        resultados.setText("jLabel1");
